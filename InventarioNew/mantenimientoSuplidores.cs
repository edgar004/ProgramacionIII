...
namespace InventarioNew
{
    public partial class mantenimientoSuplidores : Mantenimientos
    {
        ...
        private void mantenimientoSuplidores_Load(object sender, EventArgs e)
        {
        ...
        private void button4_Click(object sender, EventArgs e)
        {
            ...
            string CMD = string.Format("EXEC MANTENIMIENTO_SUPLIDORES '{0}','{1}', '{2}', '{3}', '{4}'", txt_codigo.Text.Trim(), txt_nombre.Text.Trim(), txt_telefono.Text.Trim(), txt_email.Text.Trim(), estado.Checked);
        ...
        private void button2_Click(object sender, EventArgs e)
        {
            ...
            {
                string CMD = "DELETE FROM Suplidores WHERE codigo=" + txt_codigo.Text.Trim();
                ds = Utilidades.Class1.Ejecutar(CMD);
                MessageBox.Show("El suplidor se elimino correctamente.");
                txt_codigo.Text = "";
                txt_nombre.Text = "";
                txt_telefono.Text = "";
                txt_email.Text = "";
        ...
        private void txt_codigo_Leave(object sender, EventArgs e)
        {
            if (String.IsNullOrEmpty(txt_codigo.Text.Trim()))
                return;
            string CMD = "SELECT * FROM Suplidores WHERE codigo='" + txt_codigo.Text.Trim() + "'";
            ds = Utilidades.Class1.Ejecutar(CMD);
